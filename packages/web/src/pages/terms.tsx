  ...
  return (
    <Fragment>
      <Base>
        ...
        <p>
          Please read these Terms and Conditions carefully before using our Wrench mobile
        ...
        <p>
          ...
          of "Copyright Infringement" of dmca@wrench.cc and include in your notice a detailed
