  ...
  return (
    <Fragment>
      <Base>
        ...
        <p>
          Wrench AB ("us", "we", or "our") operates the Wrench mobile application (hereinafter
        ...
        <ul>
          <li>
            ...
            <p>Service is the Wrench mobile application operated by Wrench AB</p>
          </li>
          <li>
            <p>
        ...
        <h2>Use of Data</h2>
        <p>Wrench AB uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          If you are from the European Economic Area (EEA), Wrench AB legal basis for collecting and
        ...
        <p>Wrench AB may process your Personal Data because:</p>
        <ul>
        ...
        <p>
          Wrench AB will retain your Personal Data only for as long as is necessary for the purposes
        ...
        <p>
          Wrench AB will also retain Usage Data for internal analysis purposes. Usage Data is
        ...
        <p>
          Wrench AB will take all the steps reasonably necessary to ensure that your data is treated
        ...
        <p>
          If Wrench AB is involved in a merger, acquisition or asset sale, your Personal Data may be
        ...
        <p>
          Under certain circumstances, Wrench AB may be required to disclose your Personal Data if
        ...
        <p>
          Wrench AB may disclose your Personal Data in the good faith belief that such action is
          necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Wrench AB</li>
        ...
        <p>
          ...
          protection rights. Wrench AB aims to take reasonable steps to allow you to correct, amend,
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              your consent at any time where Wrench AB relied on your consent to process your
        ...
        <ul>
          <li>By email: support@wrench.cc</li>
        </ul>
      </Base>
      <Footer />
    </Fragment>
