    ...
    <Fragment>
      <Base>
        ...
        <p>
          ...
          Agree" button, downloading or using Wrench ("Application").
        </p>
        ...
        <p>
          ...
          and Wrench AB and it governs your use of the Application made available to you by Wrench
          AB.
        </p>
        ...
        <p>
          The Application is licensed, not sold, to you by Wrench AB for use strictly in accordance
        ...
        <p>
          Wrench AB grants you a revocable, non-exclusive, non-transferable, limited license to
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              trademark) of Wrench AB or its affiliates, partners, suppliers or the licensors of the
              Application.
            </p>
          </li>
        </ul>
        ...
        <p>
          ...
          exclusive property of Wrench AB.
        </p>

        <h2>Modifications to Application</h2>

        <p>
          Wrench AB reserves the right to modify, suspend or discontinue, temporarily or
        ...
        <p>
          Wrench AB may from time to time provide enhancements or improvements to the
        ...
        <p>
          ...
          You agree that Wrench AB has no obligation to (i) provide any Updates, or (ii) continue to
          provide or enable any particular features and/or functionalities of the Application to
          you.
        </p>
        ...
        <p>
          You acknowledge and agree that Wrench AB shall not be responsible for any Third-Party
          Services, including their accuracy, completeness, timeliness, validity, copyright
          compliance, legality, decency, quality or any other aspect thereof. Wrench AB does not
        ...
        <p>
          Wrench AB collects, stores, maintains, and shares information about you in accordance with
          its Privacy Policy, which is available at https:// wrench.cc/policy. By accepting this
          Agreement, you acknowledge that you hereby agree and consent to the terms and conditions
          of our Privacy Policy.
        </p>

        <h2>Term and Termination</h2>

        <p>This Agreement shall remain in effect until terminated by you or Wrench AB.</p>

        <p>
          Wrench AB may, in its sole discretion, at any time and for any or no reason, suspend or
          terminate this Agreement with or without prior notice.
        </p>

        <p>
          This Agreement will terminate immediately, without prior notice from Wrench AB, in the
        ...
        <p>
          ...
          all copies of the Application from your mobile device or from your computer.
        </p>

        <p>
          Termination of this Agreement will not limit any of Wrench AB's rights or remedies at law
        ...
        <p>
          You agree to indemnify and hold Wrench AB and its parents, subsidiaries, affiliates,
        ...
        <p>
          ...
          law, Wrench AB, on its own behalf and on behalf of its affiliates and its and their
          ...
          performance, usage or trade practice. Without limitation to the foregoing, Wrench AB
        ...
        <p>
          Without limiting the foregoing, neither Wrench AB nor any Wrench AB's provider makes any
          ...
          included thereon; (ii) that the Application will be uninterrupted or error-free; (iii) as
          to the accuracy, reliability, or currency of any information or content provided through
          the Application; or (iv) that the Application, its servers, the content, or e-mails sent
          from or on behalf of Wrench AB are free of viruses, scripts, trojan horses, worms,
        ...
        <p>
          Notwithstanding any damages that you might incur, the entire liability of Wrench AB and
        ...
        <p>
          To the maximum extent permitted by applicable law, in no event shall Wrench AB or its
          ...
          in connection with any provision of this Agreement), even if Wrench AB or any supplier has
        ...
        <p>
          Wrench AB reserves the right, at its sole discretion, to modify or replace this Agreement
        ...
        <p>
          The laws of Sweden, excluding its conflicts of law rules, shall govern this Agreement and
          your use of the Application. Your use of the Application may also be subject to other
        ...
        <p>
          The Agreement constitutes the entire agreement between you and Wrench AB regarding your
          use of the Application and supersedes all prior and contemporaneous written or oral
          agreements between you and Wrench AB.
        </p>

        <p>
          You may be subject to additional terms and conditions that apply when you use or purchase
          other Wrench AB's services, which Wrench AB will provide to you at the time of such use or
          purchase.
        </p>
      </Base>
      <Footer />
