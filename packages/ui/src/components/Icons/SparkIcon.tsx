...
function SvgSparkIcon({ small, className, style = {}, ...props }: React.SVGProps<SVGSVGElement>) {
  const width = small ? 10 : 18
  const height = small ? 11 : 20

  return (
    <svg width={width} height={height} viewBox="0 0 20 22" className={className} style={style}>
      <path
        fill="none"
