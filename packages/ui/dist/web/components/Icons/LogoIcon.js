...
function SvgLogoIcon(_a) {
    ...
    var bgColor = (black && theme.colors.black) || (white && theme.colors.white) || theme.isDark
        ...
        : inverted
            ? theme.colors.white
            : theme.colors.black;
    return (React.createElement("svg", { width: width, height: height, viewBox: "0 0 40 40", className: className, style: style, onClick: onClick },
...
exports.default = (0, styled_components_1.withTheme)(SvgLogoIcon);
