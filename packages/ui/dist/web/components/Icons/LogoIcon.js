...
function SvgLogoIcon(_a) {
    var theme = _a.theme, black = _a.black, white = _a.white, inverted = _a.inverted, props = __rest(_a, ["theme", "black", "white", "inverted"]);
    ...
    var bgColor = (black && theme.colors.black) || (white && theme.colors.white) || theme.isDark
        ...
        : inverted
            ? theme.colors.white
            : theme.colors.black;
    return (React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 40 40" }, props),
