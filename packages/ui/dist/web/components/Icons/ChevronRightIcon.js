...
function SvgChevronRightIcon(_a) {
    var _b = _a.width, width = _b === void 0 ? 11 : _b, _c = _a.height, height = _c === void 0 ? 18 : _c, className = _a.className, _d = _a.style, style = _d === void 0 ? {} : _d, onClick = _a.onClick, props = __rest(_a, ["width", "height", "className", "style", "onClick"]);
