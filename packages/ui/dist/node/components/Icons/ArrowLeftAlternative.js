...
function SvgArrowLeftAlternative(props) {
    return (React.createElement("svg", __assign({ width: 44, height: 48 }, props),
        React.createElement("defs", null,
            React.createElement("filter", { x: "-95.3%", y: "-190.6%", width: "290.6%", height: "478.1%", filterUnits: "objectBoundingBox", id: "arrow-left_svg__a" },
            ...
            React.createElement("path", { id: "arrow-left_svg__b", d: "M12 17l10 10 10-10" })),
        React.createElement("g", { fill: "none", fillRule: "evenodd" },
            React.createElement("g", { strokeLinecap: "round", strokeLinejoin: "round", transform: "matrix(0 -1 -1 0 44 46)" },
                React.createElement("use", { fill: "#000", filter: "url(#arrow-left_svg__a)", xlinkHref: "#arrow-left_svg__b" }),
                React.createElement("use", { stroke: props.theme.colors[props.color] || props.theme.colors.inverse, strokeWidth: 1.5, xlinkHref: "#arrow-left_svg__b" })),
            React.createElement("path", { d: "M0 2h44v44H0z" }))));
}
exports.default = styled_components_1.withTheme(SvgArrowLeftAlternative);
//# sourceMappingURL=ArrowLeftAlternative.js.map