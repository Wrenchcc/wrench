...
exports.CommentDocument = client_1.gql(templateObject_41 || (templateObject_41 = __makeTemplateObject(["\n    query comment($id: ID!) {\n  comment(id: $id) {\n    ...Comment\n  }\n}\n    ", ""], ["\n    query comment($id: ID!) {\n  comment(id: $id) {\n    ...Comment\n  }\n}\n    ", ""])), exports.CommentFragmentDoc);
/**
 * __useCommentQuery__
 *
...
exports.CurrentUserDocument = client_1.gql(templateObject_43 || (templateObject_43 = __makeTemplateObject(["\n    query currentUser {\n  user: currentUser {\n    avatarUrl\n    bio\n    dynamicLink\n    firstName\n    fullName\n    id\n    isOnline\n    isSilhouette\n    lastName\n    location\n    projectCount\n    username\n    website\n    role\n    settings {\n      timezone\n      locale\n    }\n    interestedIn {\n      id\n      title\n    }\n    ...UserProjects\n  }\n}\n    ", ""], ["\n    query currentUser {\n  user: currentUser {\n    avatarUrl\n    bio\n    dynamicLink\n    firstName\n    fullName\n    id\n    isOnline\n    isSilhouette\n    lastName\n    location\n    projectCount\n    username\n    website\n    role\n    settings {\n      timezone\n      locale\n    }\n    interestedIn {\n      id\n      title\n    }\n    ...UserProjects\n  }\n}\n    ", ""])), exports.UserProjectsFragmentDoc);
/**
...
exports.CurrentUserFollowingProjectsDocument = client_1.gql(templateObject_44 || (templateObject_44 = __makeTemplateObject(["\n    query currentUserFollowingProjects($after: String, $first: Int = 5) {\n  user: currentUser {\n    id\n    projects: followingProjects(after: $after, first: $first) {\n      pageInfo {\n        hasNextPage\n      }\n      edges {\n        cursor\n        node {\n          ...Project\n          cover {\n            uri\n            default\n          }\n        }\n      }\n    }\n  }\n}\n    ", ""], ["\n    query currentUserFollowingProjects($after: String, $first: Int = 5) {\n  user: currentUser {\n    id\n    projects: followingProjects(after: $after, first: $first) {\n      pageInfo {\n        hasNextPage\n      }\n      edges {\n        cursor\n        node {\n          ...Project\n          cover {\n            uri\n            default\n          }\n        }\n      }\n    }\n  }\n}\n    ", ""])), exports.ProjectFragmentDoc);
/**
...
exports.CurrentUserProjectsDocument = client_1.gql(templateObject_46 || (templateObject_46 = __makeTemplateObject(["\n    query currentUserProjects {\n  user: currentUser {\n    ...UserProjects\n  }\n}\n    ", ""], ["\n    query currentUserProjects {\n  user: currentUser {\n    ...UserProjects\n  }\n}\n    ", ""])), exports.UserProjectsFragmentDoc);
/**
...
exports.CurrentUserSettingsDocument = client_1.gql(templateObject_47 || (templateObject_47 = __makeTemplateObject(["\n    query currentUserSettings {\n  user: currentUser {\n    ...UserSettings\n  }\n}\n    ", ""], ["\n    query currentUserSettings {\n  user: currentUser {\n    ...UserSettings\n  }\n}\n    ", ""])), exports.UserSettingsFragmentDoc);
/**
...
exports.FeedDocument = client_1.gql(templateObject_48 || (templateObject_48 = __makeTemplateObject(["\n    query feed($after: String, $first: Int = 5) {\n  feed {\n    posts: postsConnection(after: $after, first: $first) @connection(key: \"posts\") {\n      pageInfo {\n        hasNextPage\n      }\n      edges {\n        cursor\n        node {\n          ...Post\n        }\n      }\n    }\n  }\n}\n    ", ""], ["\n    query feed($after: String, $first: Int = 5) {\n  feed {\n    posts: postsConnection(after: $after, first: $first) @connection(key: \"posts\") {\n      pageInfo {\n        hasNextPage\n      }\n      edges {\n        cursor\n        node {\n          ...Post\n        }\n      }\n    }\n  }\n}\n    ", ""])), exports.PostFragmentDoc);
/**
 * __useFeedQuery__
 *
...
exports.FilesDocument = client_1.gql(templateObject_49 || (templateObject_49 = __makeTemplateObject(["\n    query files($after: String, $first: Int = 10) @connection(key: \"files\") {\n  files(after: $after, first: $first) {\n    pageInfo {\n      hasNextPage\n    }\n    edges {\n      cursor\n      node {\n        id\n        uri\n        postId\n      }\n    }\n  }\n}\n    "], ["\n    query files($after: String, $first: Int = 10) @connection(key: \"files\") {\n  files(after: $after, first: $first) {\n    pageInfo {\n      hasNextPage\n    }\n    edges {\n      cursor\n      node {\n        id\n        uri\n        postId\n      }\n    }\n  }\n}\n    "])));
/**
 * __useFilesQuery__
 *
...
exports.GrowthDocument = client_1.gql(templateObject_51 || (templateObject_51 = __makeTemplateObject(["\n    query growth($type: GrowthType!) {\n  growth(type: $type) {\n    date\n    count\n  }\n}\n    "], ["\n    query growth($type: GrowthType!) {\n  growth(type: $type) {\n    date\n    count\n  }\n}\n    "])));
/**
 * __useGrowthQuery__
 *
...
exports.MetaDocument = client_1.gql(templateObject_54 || (templateObject_54 = __makeTemplateObject(["\n    query meta {\n  meta {\n    totalUsers\n    totalUsersToday\n    totalPostsToday\n    totalProjectsToday\n    totalCommentsToday\n    totalFilesToday\n    totalComments\n    totalProjects\n    totalPosts\n    totalFiles\n  }\n}\n    "], ["\n    query meta {\n  meta {\n    totalUsers\n    totalUsersToday\n    totalPostsToday\n    totalProjectsToday\n    totalCommentsToday\n    totalFilesToday\n    totalComments\n    totalProjects\n    totalPosts\n    totalFiles\n  }\n}\n    "])));
/**
 * __useMetaQuery__
 *
...
exports.PostDocument = client_1.gql(templateObject_56 || (templateObject_56 = __makeTemplateObject(["\n    query post($id: ID!) {\n  post(id: $id) {\n    ...Post\n  }\n}\n    ", ""], ["\n    query post($id: ID!) {\n  post(id: $id) {\n    ...Post\n  }\n}\n    ", ""])), exports.PostFragmentDoc);
/**
 * __usePostQuery__
 *
...
exports.PostsDocument = client_1.gql(templateObject_57 || (templateObject_57 = __makeTemplateObject(["\n    query posts($after: String, $first: Int = 5) @connection(key: \"posts\") {\n  posts(after: $after, first: $first) {\n    pageInfo {\n      hasNextPage\n    }\n    edges {\n      cursor\n      node {\n        ...Post\n      }\n    }\n  }\n}\n    ", ""], ["\n    query posts($after: String, $first: Int = 5) @connection(key: \"posts\") {\n  posts(after: $after, first: $first) {\n    pageInfo {\n      hasNextPage\n    }\n    edges {\n      cursor\n      node {\n        ...Post\n      }\n    }\n  }\n}\n    ", ""])), exports.PostFragmentDoc);
/**
 * __usePostsQuery__
 *
...
exports.ProjectTypesDocument = client_1.gql(templateObject_61 || (templateObject_61 = __makeTemplateObject(["\n    query projectTypes {\n  types: projectTypes {\n    id\n    title\n    imageUrl\n  }\n}\n    "], ["\n    query projectTypes {\n  types: projectTypes {\n    id\n    title\n    imageUrl\n  }\n}\n    "])));
/**
...
exports.RepliesDocument = client_1.gql(templateObject_64 || (templateObject_64 = __makeTemplateObject(["\n    query replies($id: ID!, $after: String, $first: Int = 5) {\n  comment(id: $id) {\n    replies: repliesConnection(after: $after, first: $first) {\n      pageInfo {\n        hasNextPage\n      }\n      totalCount\n      edges {\n        cursor\n        node {\n          ...Comment\n        }\n      }\n    }\n  }\n}\n    ", ""], ["\n    query replies($id: ID!, $after: String, $first: Int = 5) {\n  comment(id: $id) {\n    replies: repliesConnection(after: $after, first: $first) {\n      pageInfo {\n        hasNextPage\n      }\n      totalCount\n      edges {\n        cursor\n        node {\n          ...Comment\n        }\n      }\n    }\n  }\n}\n    ", ""])), exports.CommentFragmentDoc);
/**
 * __useRepliesQuery__
 *
...
exports.SimilarProjectsDocument = client_1.gql(templateObject_69 || (templateObject_69 = __makeTemplateObject(["\n    query similarProjects($id: ID!, $first: Int = 5) {\n  similarProjects(id: $id, first: $first) {\n    edges {\n      cursor\n      node {\n        cover {\n          uri\n        }\n        ...Project\n      }\n    }\n  }\n}\n    ", ""], ["\n    query similarProjects($id: ID!, $first: Int = 5) {\n  similarProjects(id: $id, first: $first) {\n    edges {\n      cursor\n      node {\n        cover {\n          uri\n        }\n        ...Project\n      }\n    }\n  }\n}\n    ", ""])), exports.ProjectFragmentDoc);
/**
...
exports.UserDocument = client_1.gql(templateObject_70 || (templateObject_70 = __makeTemplateObject(["\n    query user($username: LowercaseString!, $after: String, $first: Int = 5) {\n  user(username: $username) {\n    ...User\n    projects: projectsConnection {\n      edges {\n        node {\n          ...Project\n          cover {\n            uri\n            default\n          }\n        }\n      }\n    }\n    posts: postsConnection(after: $after, first: $first) @connection(key: \"posts\") {\n      edges {\n        cursor\n        node {\n          ...Post\n        }\n      }\n      pageInfo {\n        hasNextPage\n      }\n    }\n  }\n}\n    ", "\n", "\n", ""], ["\n    query user($username: LowercaseString!, $after: String, $first: Int = 5) {\n  user(username: $username) {\n    ...User\n    projects: projectsConnection {\n      edges {\n        node {\n          ...Project\n          cover {\n            uri\n            default\n          }\n        }\n      }\n    }\n    posts: postsConnection(after: $after, first: $first) @connection(key: \"posts\") {\n      edges {\n        cursor\n        node {\n          ...Post\n        }\n      }\n      pageInfo {\n        hasNextPage\n      }\n    }\n  }\n}\n    ", "\n", "\n", ""])), exports.UserFragmentDoc, exports.ProjectFragmentDoc, exports.PostFragmentDoc);
/**
 * __useUserQuery__
 *
...
exports.UserFollowingProjectsDocument = client_1.gql(templateObject_71 || (templateObject_71 = __makeTemplateObject(["\n    query userFollowingProjects($username: LowercaseString!, $after: String, $first: Int = 5) {\n  user(username: $username) {\n    id\n    projects: followingProjects(after: $after, first: $first) {\n      pageInfo {\n        hasNextPage\n      }\n      edges {\n        cursor\n        node {\n          ...Project\n          cover {\n            uri\n            default\n          }\n        }\n      }\n    }\n  }\n}\n    ", ""], ["\n    query userFollowingProjects($username: LowercaseString!, $after: String, $first: Int = 5) {\n  user(username: $username) {\n    id\n    projects: followingProjects(after: $after, first: $first) {\n      pageInfo {\n        hasNextPage\n      }\n      edges {\n        cursor\n        node {\n          ...Project\n          cover {\n            uri\n            default\n          }\n        }\n      }\n    }\n  }\n}\n    ", ""])), exports.ProjectFragmentDoc);
/**
