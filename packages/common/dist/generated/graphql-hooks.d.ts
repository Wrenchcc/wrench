...
export declare function useGrowthLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GrowthQuery, GrowthQueryVariables>): [(options?: ApolloReactHooks.QueryLazyOptions<GrowthQueryVariables> | undefined) => void, ApolloReactCommon.QueryResult<GrowthQuery, GrowthQueryVariables>];
...
export declare function useProjectSuggestionsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ProjectSuggestionsQuery, ProjectSuggestionsQueryVariables>): [(options?: ApolloReactHooks.QueryLazyOptions<ProjectSuggestionsQueryVariables> | undefined) => void, ApolloReactCommon.QueryResult<ProjectSuggestionsQuery, ProjectSuggestionsQueryVariables>];
...
export declare function useRecentCommentsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<RecentCommentsQuery, RecentCommentsQueryVariables>): [(options?: ApolloReactHooks.QueryLazyOptions<RecentCommentsQueryVariables> | undefined) => void, ApolloReactCommon.QueryResult<RecentCommentsQuery, RecentCommentsQueryVariables>];
...
export declare function useSearchProjectsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SearchProjectsQuery, SearchProjectsQueryVariables>): [(options?: ApolloReactHooks.QueryLazyOptions<SearchProjectsQueryVariables> | undefined) => void, ApolloReactCommon.QueryResult<SearchProjectsQuery, SearchProjectsQueryVariables>];
...
export declare function useSearchUsersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SearchUsersQuery, SearchUsersQueryVariables>): [(options?: ApolloReactHooks.QueryLazyOptions<SearchUsersQueryVariables> | undefined) => void, ApolloReactCommon.QueryResult<SearchUsersQuery, SearchUsersQueryVariables>];
