...
export default class Cropper extends React.PureComponent<PickerProps> {
  ...
  constructor(props: PickerProps) {
    ...
    this.transX = Cropper.withBouncyLimits(
      Cropper.withDecaying(
        Cropper.withAddingFocalDisplacement(
          Cropper.withPreservingAdditiveOffset(this.dragX, this.panState, this.scale),
    ...
    this.transY = Cropper.withBouncyLimits(
      Cropper.withDecaying(
        Cropper.withAddingFocalDisplacement(
          Cropper.withPreservingAdditiveOffset(this.dragY, this.panState, this.scale),
          ...
          cond(
            ...
            [
              cond(
                ...
                set(
                  limitedVal,
                  Cropper.runSpring(springClock, limitedVal, minBound, flagWasRunSpring)
                ),
                cond(
                  greaterThan(limitedVal, maxBound),
                  set(
                    limitedVal,
                    Cropper.runSpring(springClock, limitedVal, maxBound, flagWasRunSpring)
                  ),
                  [
  ...
  private render() {
    return (
      ...
      >
        <Animated.Code
          exec={call([this.scale, this.transX, this.transY], this.props.onPhotoResize)}
        />
        <PinchGestureHandler
                        ...
                        cond(
                          ...
                          cond(
                            ...
                            [
                              ...
                              set(this.opacity, Cropper.runTiming(this.gridClock, this.opacity, 1)),
                            ],
                            set(this.opacity, Cropper.runTiming(this.gridClock, this.opacity, 0))
                          )
                        ),
                        this.opacity,
                      ])}
