...
import { navigateToFeed } from 'navigation-old/actions'
import { addPost } from 'graphql-old/mutations/post/addPost'
import { getCurrentUserProjects } from 'graphql-old/queries/user/getCurrentUserProjects'
